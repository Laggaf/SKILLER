...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:meu criador\n' // criador
            + 'ORG: LAGGAF;\n' // nome do bot
            + 'TEL;type=CELL;type=VOICE;waid=15098411753:+1 509 841-1753\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.'
blocked = []
limitawal = '999999999'
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
      		...
      		mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD Laggaf BOT*',
					benned: 'Você está banido do bot, por favor, contate o proprietário para retirar seu ban',
					ownerG: '[❗] Laggaf? Este é um recurso especial para o Laggaf❌',
					ownerB: '[❗] Laggaf? Este é um recurso especial para o Laggaf ❌',
			...
			const ownerNumber = ["5513997335061@s.whatsapp.net","15098411753@s.whatsapp.net"] // coloque seu numero
			const mod = [ownerNumber,"5513997335061@s.whatsapp.net","15098411753@s.whatsapp.net"]//seu numero
			const adminbotnumber = ["5513997335061@s.whatsapp.net","15098411753@s.whatsapp.net"]//seu numero
			const frendsowner = ["5513997335061@s.whatsapp.net"]//seu numero
			const premium = ["5513997335061@s.whatsapp.net","15098411753@s.whatsapp.net",]
...
reply("oi posso ajudar")
	...
	if (messagesC.includes(".faustinho")){
			...
			switch(command) {
				...
				case 'addvip':
					if (!isOwner) return reply(mess.only.ownerB)
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o Laggaf ou digite * # Daftarvip * para adquirir o acesso Premium!' ,text, { quoted: mek })
...
break
          ...
          reply('Espere..')
                                       ...
                                       if (args[0].startsWith('5098411753')) return reply('Falha ao ligar para o número do bot')
                                       if (args[0].startsWith('15098411753')) return reply('Falha ao ligar para o número do proprietário')
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/15098411753/*╰──────*「 * LAGGAF * 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO LAGGAF BOT_*\n*_Ketik #daftarvip*' })
					break
case 'daftarvip':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* LAGGAF\n*YOUTUBE:* https://www.youtube.com/channel/UC36G17QR3yGDiorwN013YRg/videos\n*WPP:* wa.me/+15098411753\n*INSTA:* @laggaf\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				//_IMAGENS
				case 'boanoite':
					memein = await kagApi.memeindo()
